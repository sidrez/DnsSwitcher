...
public sealed class SettingsForm : Form
{
    ...
    {
        _config = config; Text = "Настройки DnsSwitcher"; ClientSize = new Size(650, 475); FormBorderStyle = FormBorderStyle.FixedDialog; MaximizeBox = false; BackColor = Color.FromArgb(30, 30, 30); ForeColor = Color.Gainsboro; StartPosition = FormStartPosition.CenterParent;
        ...
        var check = new Button { Text = "Проверить актуальность IP", Location = new Point(20, 420), Size = new Size(220, 32) }; check.Click += async (_, _) => await CheckAsync(); Controls.Add(check);
        var save = new Button { Text = "Сохранить", DialogResult = DialogResult.OK, Location = new Point(450, 420), Size = new Size(85, 32) }; save.Click += (_, _) => Save(); Controls.Add(save);
        var cancel = new Button { Text = "Отмена", DialogResult = DialogResult.Cancel, Location = new Point(545, 420), Size = new Size(85, 32) }; Controls.Add(cancel); AcceptButton = save; CancelButton = cancel;
    }
